       	...
       	<div class="left_content">
            ...
            <table class="cart_table">
            	...
            	<tr>
					...
					<td><a href="deletecart.php?var=<?php echo $row['model']?>" >Delete</a></td>
                </tr>   
                <?php		
								}
            ...
            <div align="left"><a href="checkpin.php" >&lt; COD</a></div>
            <div align="right"><a href="add_payement.php" >Online Payment &gt;</a></div>
